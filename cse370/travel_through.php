...
<head>
    ...
    <title>travel_through</title>
    <link rel="stylesheet" href="vehicle_dis.css">
</head>
<body>
<header><h1>Vehicle And Route Relation</h1></header>
<?php 
require("connection.php");
$sql="SELECT * FROM `travel_through`";
...
<table>
	...
	<tr>
		...
		<td>
			<form action="travel_through_delete.php" method="post">
	...
	<form action="travel_through_insert.php" method="post">
	<tr>
		<td>
